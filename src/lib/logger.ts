 ...
 *  LLM did/didn't follow instructions. Best-effort: logging is diagnostic,
 *  so a disk-full or permissions error here must not fail the /cv/generate
 *  request that's actually doing the work. */
